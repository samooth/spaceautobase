...
module.exports = class SystemView extends ReadyResource {
  constructor (core, { checkout = 0 } = {}) {
    ...
    this.db = new Spacebee(core, { keyEncoding: 'binary', extension: false, checkout, sessions: typeof core.session === 'function' })
  ...
  addHead (node) {
    ...
    for (let i = 0; i < this.heads.length; i++) {
      ...
      if (!hasDependency(node, head)) {
        ...
        // https://github.com/holepunchto/spaceautobase-next/pull/237
