...
const encryptionKey = argv.includes('--encrypt-all') ? b4a.alloc(32).fill('spaceautobase-encryption-test') : undefined
...
function createBase (store, key, t, opts = {}) {
  ...
  const base = new SpaceAutobase(store.session(), key, moreOpts)
